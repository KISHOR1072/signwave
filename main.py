...
os.environ['STANFORD_MODELS'] = os.path.join(BASE_DIR, r"C:\Users\LENOVO\Documents\test\AudioToSignLanguageConverter-master\stanford-parser-full-2015-04-20\stanford-parser-full-2018-10-17\edu\stanford\nlp\models\lexparser\englishPCFG.ser.gz")
...
stop_words = set(["am","are","is","was","were","be","being","been","have","has","had",
					"does","did","could","should","would","can","shall","will","may","might","must","let","to"])
